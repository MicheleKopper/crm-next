  ...
  return (
    <div className="grid grid-cols-[104px_2fr_1.5fr_1.5fr_auto] items-start gap-4 rounded-lg border-b border-navy-100 py-4 px-2 -mx-2 last:border-b-0 hover:bg-navy-50">
      ...
      <div className="min-w-0 space-y-1 text-sm">
        <p className="truncate font-semibold text-navy-900" title={customer.displayName}>
          {customer.displayName}
        </p>
        <p className="truncate text-navy-500" title={customer.legalName}>
          {customer.legalName}
        </p>
        <p className="truncate text-navy-400">{customer.taxId}</p>
      </div>
